  ...
  module Globalize3
    module FormBuilderExtension
      ...
      def translated_inputs(name = "Translations", options = {}, &block)
        ...
        wrapper_html_class = options.fetch(:wrapper_html_class, nil)
        form_buffers.last << template.content_tag(:div, class: "activeadmin-translations #{wrapper_html_class}") do
